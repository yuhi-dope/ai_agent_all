...
def bpo_saas_executor_node(state: BPOState) -> dict[str, Any]:
    """SaaS 操作を実行するノード.
    ...
    Returns:
        {"saas_results": [...], "status": "executing" | "saas_error"}
    """
    ...
    if not operations:
        return {"saas_results": [], "status": "completed"}
    ...
    return {"saas_results": results, "status": "executing"}
