...
│  └────────────────────┘  └────────────────────────────┘         │
│                                                                  │
│  ■ 拡張モジュール（セグメント別に刺さるものを選択提供）            │
│                                                                  │
│  ┌────────────────────┐  ┌────────────────────────────┐         │
│  │ ⑨ 原価管理          │  │ ⑩ 受注・納期管理           │         │
│  │ 見積vs実績の差異分析 │  │ 受注ステータス+納期回答     │         │
│  │ ★S4自動車の1st      │  │ +遅延アラート              │         │
│  └────────────────────┘  └────────────────────────────┘         │
│                                                                  │
│  ┌────────────────────┐  ┌────────────────────────────┐         │
│  │ ⑪ 営業・顧客管理    │  │ ⑫ 図面管理                 │         │
│  │ 見積→受注→リピート  │  │ バージョン管理+類似検索     │         │
│  │ 失注分析+受注率向上  │  │ 過去図面の再利用促進        │         │
│  └────────────────────┘  └────────────────────────────┘         │
│                                                                  │
│  ┌────────────────────┐  ┌────────────────────────────┐         │
│  │ ⑬ 外注管理          │  │ ⑭ 技能・資格管理           │         │
│  │ 外注先選定+品質+コスト│  │ 技能マップ+資格期限+教育   │         │
│  │ 表面処理/熱処理等    │  │ 溶接資格/特殊工程認定      │         │
│  └────────────────────┘  └────────────────────────────┘         │
│                                                                  │
│  ┌────────────────────┐  ┌────────────────────────────┐         │
│  │ ⑮ 安全衛生          │  │ ⑯ 補助金・助成金           │         │
│  │ KY活動+ヒヤリハット  │  │ ものづくり補助金マッチング  │         │
│  │ +労災対応            │  │ +IT導入補助金+申請支援     │         │
│  └────────────────────┘  └────────────────────────────┘         │
│                                                                  │
│  ┌────────────────────┐  ┌────────────────────────────┐         │
│  │ ⑰ CO2・環境対応     │  │ ⑱ 多言語対応               │         │
│  │ Scope1-3排出量算定   │  │ 作業指示+手順書+日報の      │         │
│  │ サプライチェーン対応  │  │ 多言語化（越/尼/英/中）    │         │
│  └────────────────────┘  └────────────────────────────┘         │
└──────────────────────────────────────────────────────────────────┘
```
...
| セグメント | 1st | 2nd | 3rd | 拡張で刺さるもの |
|---|---|---|---|---|
| **S1** 民生×独立 | ①見積AI | ②生産計画 | ③品質管理 | ⑪営業管理, ⑯補助金 |
| **S2** 半導体装置 | ①見積AI | ③品質管理 | ②生産計画 | ⑫図面管理, ⑨原価管理 |
| **S3** 産業機械 | ①見積AI | ②生産計画 | ⑨原価管理 | ⑩受注納期, ⑬外注管理 |
| **S4** 自動車 | ⑨原価管理 | ③品質管理 | ②生産計画 | ⑤SOP管理, ⑰CO2 |
| **S5** 医療機器 | ③品質管理 | ①見積AI | ⑦仕入管理 | ⑤SOP管理, ⑭技能資格 |
| **S6** 航空宇宙 | ③品質管理 | ⑤SOP管理 | ①見積AI | ⑭技能資格, ⑬外注管理 |
| **S7** 建設機械 | ①見積AI | ②生産計画 | ③品質管理 | ⑬外注管理, ⑮安全衛生 |
| **S8** 電子・電気 | ①見積AI | ⑩受注納期 | ③品質管理 | ④在庫最適化, ⑨原価管理 |
| **S9** 食品OEM | ③品質管理 | ⑨原価管理 | ④在庫最適化 | ⑤SOP管理, ⑱多言語 |
| **S10** 見込み生産 | ブレインのみ | — | — | ⑯補助金, ⑮安全衛生 |
