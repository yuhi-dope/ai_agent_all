...
以下の設計書・数量計算書から、工種・種別・細別・規格・数量・単位を抽出してください。
...
[
  {
    "sort_order": 1,
    "category": "工種名（例: 土工）",
    "subcategory": "種別名（例: 掘削工）",
    "detail": "細別名（例: バックホウ掘削）",
    "specification": "規格（例: 0.8m3級）",
    "quantity": 1500.0,
    "unit": "m3",
    "source_document": "抽出元の参照情報"
  }
]
...
- 数量は数値で出力（文字列不可）
- 単位は m3, m2, m, t, 本, 箇所, 式 等の標準単位
- 不明な項目は "notes" フィールドに記載してください
- 工種の順序は一般的な施工順序に従ってください"""
