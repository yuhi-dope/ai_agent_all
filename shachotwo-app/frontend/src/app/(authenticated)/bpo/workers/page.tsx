  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setShowForm(!showForm)}>{showForm ? "キャンセル" : "新規登録"}</Button>
      </div>
      ...
      {loading ? (
        ...
        <Card><CardContent className="py-12 text-center text-muted-foreground">作業員が登録されていません。</CardContent></Card>
      ) : (
