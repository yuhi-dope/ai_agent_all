...
@router.post("/medical_receipt/run", response_model=PipelineRunResponse)
async def run_medical_receipt_pipeline(
    ...
    task = BPOTask(
        ...
        pipeline="clinic/medical_receipt",
