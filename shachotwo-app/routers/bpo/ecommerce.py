...
@router.post("/product_listing/run", response_model=PipelineRunResponse)
async def run_product_listing_pipeline(
    ...
    task = BPOTask(
        ...
        pipeline="ecommerce/product_listing",
