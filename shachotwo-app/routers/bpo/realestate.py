...
@router.post("/rent_collection/run", response_model=PipelineRunResponse)
async def run_rent_collection_pipeline(
    ...
    task = BPOTask(
        ...
        pipeline="realestate/rent_collection",
