...
@router.post("/booking_recall/run", response_model=PipelineRunResponse)
async def run_booking_recall_pipeline(
    ...
    task = BPOTask(
        ...
        pipeline="beauty/booking_recall",
