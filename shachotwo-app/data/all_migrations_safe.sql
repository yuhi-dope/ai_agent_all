...
CREATE INDEX IF NOT EXISTS idx_knowledge_sessions_company_status ON knowledge_sessions (company_id, extraction_status);
CREATE INDEX IF NOT EXISTS idx_knowledge_items_company_active ON knowledge_items (company_id, is_active, department);
CREATE INDEX IF NOT EXISTS idx_knowledge_items_company_category ON knowledge_items (company_id, category);
CREATE INDEX IF NOT EXISTS idx_knowledge_relations_company ON knowledge_relations (company_id);
...
CREATE INDEX IF NOT EXISTS idx_snapshots_company ON company_state_snapshots (company_id, snapshot_at DESC);
CREATE INDEX IF NOT EXISTS idx_proposals_company_status ON proactive_proposals (company_id, status);
CREATE INDEX IF NOT EXISTS idx_decision_rules_company ON decision_rules (company_id, department, is_active);
CREATE INDEX IF NOT EXISTS idx_tool_connections_company ON tool_connections (company_id, health_status);
CREATE INDEX IF NOT EXISTS idx_execution_logs_company ON execution_logs (company_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_audit_logs_company_time ON audit_logs (company_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_audit_logs_target ON audit_logs (target_type, target_id);
CREATE INDEX IF NOT EXISTS idx_consent_records_company_user ON consent_records (company_id, user_id);
CREATE INDEX IF NOT EXISTS idx_consent_records_active ON consent_records (company_id) WHERE revoked_at IS NULL;
...
DROP POLICY IF EXISTS "knowledge_sessions_tenant_isolation" ON knowledge_sessions;
...
DROP POLICY IF EXISTS "knowledge_relations_tenant_isolation" ON knowledge_relations;
...
DROP POLICY IF EXISTS "snapshots_tenant_isolation" ON company_state_snapshots;
...
DROP POLICY IF EXISTS "proposals_tenant_isolation" ON proactive_proposals;
CREATE POLICY "proposals_tenant_isolation" ON proactive_proposals
    USING (company_id = (current_setting('app.company_id', true))::UUID);

ALTER TABLE decision_rules ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "decision_rules_tenant_isolation" ON decision_rules;
...
DROP POLICY IF EXISTS "execution_logs_tenant_isolation" ON execution_logs;
...
DROP TRIGGER IF EXISTS trg_decision_rules_updated_at ON decision_rules;
CREATE TRIGGER trg_decision_rules_updated_at
    BEFORE UPDATE ON decision_rules
    FOR EACH ROW EXECUTE FUNCTION update_updated_at();


-- === db/migrations/002_vector_search_function.sql ===
...
-- === db/migrations/003_embedding_768.sql ===
...
-- === db/migrations/004_audit_logs_insert_only_policy.sql ===
...
-- === db/migrations/005_invitations.sql ===
...
-- === db/migrations/006_bpo_base.sql ===
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS bpo_invoices (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    company_id UUID NOT NULL REFERENCES companies(id),
...
-- 2. bpo_expenses — 経費記録
-- =============================================================================
CREATE TABLE IF NOT EXISTS bpo_expenses (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    company_id UUID NOT NULL REFERENCES companies(id),
    user_id UUID NOT NULL REFERENCES users(id),
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS bpo_vendors (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    company_id UUID NOT NULL REFERENCES companies(id),
    name TEXT NOT NULL,
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS bpo_permits (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    company_id UUID NOT NULL REFERENCES companies(id),
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS bpo_approvals (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    company_id UUID NOT NULL REFERENCES companies(id),
...
-- === db/migrations/007_bpo_construction.sql ===
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS unit_price_master (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    company_id UUID NOT NULL REFERENCES companies(id),
    category TEXT NOT NULL,
    subcategory TEXT,
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS public_labor_rates (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- === db/migrations/008_qa_sessions.sql ===
...
-- インデックス
CREATE INDEX IF NOT EXISTS idx_qa_sessions_company ON qa_sessions(company_id);
CREATE INDEX IF NOT EXISTS idx_qa_sessions_company_created ON qa_sessions(company_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_qa_sessions_answer_status ON qa_sessions(company_id, answer_status);

-- RLS
ALTER TABLE qa_sessions ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "qa_sessions_select" ON qa_sessions;
CREATE POLICY qa_sessions_select ON qa_sessions
    FOR SELECT USING (company_id = (current_setting('app.company_id', true))::uuid);

DROP POLICY IF EXISTS "qa_sessions_insert" ON qa_sessions;
CREATE POLICY qa_sessions_insert ON qa_sessions
    FOR INSERT WITH CHECK (company_id = (current_setting('app.company_id', true))::uuid);


-- === db/migrations/009_knowledge_bpo_fields.sql ===
...
-- === db/migrations/010_knowledge_session_files.sql ===
...
-- === db/migrations/011_session_cost_tracking.sql ===
...
-- === db/migrations/012_feedback_learning.sql ===
...
-- === db/migrations/013_llm_call_logs.sql ===
...
DROP POLICY IF EXISTS "llm_call_logs_read" ON llm_call_logs;
...
-- === db/migrations/014_bpo_manufacturing.sql ===
...
-- === db/migrations/015_execution_hitl.sql ===
...
-- === db/migrations/016_knowledge_half_life.sql ===
...
-- === db/migrations/017_qa_usage_rpc.sql ===
...
-- === db/migrations/018_bpo_hitl_all_pipelines.sql ===
...
-- === db/migrations/019_knowledge_feedback_rpc.sql ===
...
-- === db/migrations/020_mfg_quoting_engine.sql ===
...
-- === db/migrations/021_sfa_crm_cs_tables.sql ===
...
-- =============================================================================
ALTER TABLE opportunities ADD COLUMN IF NOT EXISTS customer_id UUID REFERENCES customers(id);
...
-- === db/migrations/022_learning_tables.sql ===
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS outreach_performance (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID NOT NULL REFERENCES companies(id),
...
-- === db/migrations/023_pricing_tables.sql ===
...
DROP POLICY IF EXISTS "pricing_modules_tenant" ON pricing_modules;
CREATE POLICY pricing_modules_tenant ON pricing_modules
    USING (company_id = current_setting('app.company_id', true)::UUID);

DROP POLICY IF EXISTS "pricing_discounts_tenant" ON pricing_discounts;
CREATE POLICY pricing_discounts_tenant ON pricing_discounts
    USING (company_id = current_setting('app.company_id', true)::UUID);

-- インデックス
CREATE INDEX IF NOT EXISTS idx_pricing_modules_company ON pricing_modules (company_id, is_active);
CREATE INDEX IF NOT EXISTS idx_pricing_discounts_company ON pricing_discounts (company_id, is_active);
...
-- === db/migrations/024_onboarding_plan.sql ===
...
-- === db/migrations/025_gws_sync_tables.sql ===
...
DROP POLICY IF EXISTS "watch_channels_tenant_isolation" ON watch_channels;
...
DROP POLICY IF EXISTS "gws_sync_state_tenant_isolation" ON gws_sync_state;
CREATE POLICY gws_sync_state_tenant_isolation ON gws_sync_state
    USING (company_id = current_setting('app.company_id')::uuid);


-- === db/migrations/026_lead_enrichment_fields.sql ===
...
-- === db/migrations/027_learned_rules.sql ===
...
DROP POLICY IF EXISTS "learned_rules_tenant" ON learned_rules;
...
-- === db/migrations/028_prompt_versions.sql ===
...
-- サービスロールは全件アクセス可
DROP POLICY IF EXISTS "service_role_all" ON prompt_versions;
CREATE POLICY "service_role_all" ON prompt_versions
    FOR ALL TO service_role USING (true) WITH CHECK (true);

-- 認証ユーザーは自社データのみ参照・操作可（NULLは全社共通として全員参照可）
DROP POLICY IF EXISTS "tenant_select" ON prompt_versions;
...
DROP POLICY IF EXISTS "tenant_insert" ON prompt_versions;
...
DROP POLICY IF EXISTS "tenant_update" ON prompt_versions;
...
-- === db/migrations/029_bpo_case_studies.sql ===
...
DROP POLICY IF EXISTS "bpo_case_studies_tenant_isolation" ON bpo_case_studies;
...
DROP POLICY IF EXISTS "bpo_case_milestones_tenant_isolation" ON bpo_case_milestones;
...
DROP POLICY IF EXISTS "bpo_case_tags_tenant_isolation" ON bpo_case_tags;
